...
//ventaResponse = mapper.map(venta, VentaResponse.class);
    ...
    public ResponseEntity<VentaResponse> createVenta(@RequestBody VentaEfectivoRequest
                                                             datosVenta) {
...
//VentaEfectivo venta = mapper.map(datosVenta, VentaEfectivo.class);
    ...
    public ResponseEntity<VentaResponse> createVenta(@RequestBody VentaTarjetaRequest
                                                             datosVenta) {
...
//VentaTarjeta venta = mapper.map(datosVenta, VentaTarjeta.class);
     ...
     * @return
     */
    private ResponseEntity<VentaResponse> grabarVenta(VentaEfectivo venta, VentaResponse
            ventaResponse) {
...
//ventaResponse = mapper.map(venta, VentaResponse.class);
     ...
     * @return
     */
    private ResponseEntity<VentaResponse> grabarVenta(VentaTarjeta venta, VentaResponse
            ventaResponse) {
...
//ventaResponse = mapper.map(venta, VentaResponse.class);
    ...
    public ResponseEntity<VentaResponse> createItem(@PathVariable("ventaId") long
                                                            ventaId,
...
//ventaResponse = mapper.map((VentaTarjeta) venta,VentaResponse.class);
    ...
    public ResponseEntity<VentaResponse> modifyItem(@PathVariable("ventaId") long
                                                            ventaId,
...
//ventaResponse = mapper.map((VentaTarjeta) venta,VentaResponse.class);
    ...
    public ResponseEntity<VentaResponse> deleteCliente(@PathVariable("ventaId") long
                                                               ventaId,
